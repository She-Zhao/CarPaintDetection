...
class Host():
    ...
    def Socket_init(self):
        ...
        # return client_socket_1,client_socket_2,client_socket_3,client_socket_4
        # return client_socket_1
...
#     while(1):
#        # if FIRST_TIME_IMSHOW :
#             #image = host.Projected_init()
#             #FIRST_TIME_IMSHOW = 0
        
#         t = time.time()
#         if int(t)%5 == 0 :                    #收到机械臂命令
#             host.Take_photo()
